  ...
  return <section className="relative min-h-[90vh] flex flex-col justify-center overflow-hidden bg-gradient-to-br from-primary via-primary to-primary/90" aria-label="Section principale - Comparateur d'assurances">
      ...
      <div className="container mx-auto px-4 relative z-10 py-8 md:py-12">
        ...
        <div className="text-center mb-8">
          ...
          duration: 0.5,
          delay: 0.2
        }} className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-black text-primary-foreground mb-4 leading-tight font-[Inter]">Le site pour trouver son assurance moins chère, sans compromis, sans compromis.<br />
          ...
          delay: 0.3
            ...
            Comparez <span className="font-bold">Le site pour trouver son assurance moins chère,
sans compromis.</span> en 2 minutes.
