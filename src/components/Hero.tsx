        ...
        <div className="flex flex-col md:flex-row md:items-center md:gap-8 lg:gap-12 mb-10 md:mb-12">
          ...
          <div className="hidden md:flex shrink-0 justify-center items-center animate-fade-in-delay">
            <div className="relative inline-block">
              ...
              <div className="hidden lg:block absolute -bottom-6 -left-8 bg-white rounded-2xl px-4 py-2 shadow-[0_8px_24px_-8px_rgba(0,0,0,0.25)] animate-fade-in-delay z-10 -rotate-3">
                <p className="text-primary font-bold text-sm whitespace-nowrap">
                  70+ assureurs comparés
                </p>
                <div className="absolute -top-1.5 right-5 w-3 h-3 bg-white transform rotate-45" />
              </div>
              <div className="hidden lg:block absolute -top-6 -left-6 bg-white rounded-2xl px-4 py-2 shadow-[0_8px_24px_-8px_rgba(0,0,0,0.25)] animate-fade-in-delay z-10 rotate-2">
                <p className="text-primary font-bold text-sm whitespace-nowrap">
                  5/5 sur 6 avis Google
                </p>
