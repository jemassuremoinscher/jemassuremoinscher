              ...
              <div>
                ...
                <div className="space-y-3">
                  <p className="text-xs text-primary-foreground/50 leading-relaxed">
                    Jemassuremoinscher.fr est un comparateur 100&nbsp;% indépendant. Notre service est gratuit pour les utilisateurs&nbsp;; nous sommes rémunérés par nos partenaires assureurs lors de la mise en relation.
                  </p>
                  <p className="text-xs text-primary-foreground/50 leading-relaxed">
                    Immatriculé à l'ORIAS sous le N° 24 XXX XXX en qualité de courtier en assurances. Les tarifs affichés sont indicatifs et peuvent varier selon votre profil.
                  </p>
                  <p className="text-xs text-primary-foreground/50 leading-relaxed">
