      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="bg-card rounded-3xl p-6 shadow-[0_4px_16px_-6px_rgba(0,0,0,0.08)] border border-border/40 hover:shadow-[0_12px_28px_-10px_rgba(0,0,0,0.15)] hover:-translate-y-1 transition-all flex flex-col items-center text-center gap-3">
            ...
            <div className="flex items-center gap-1" aria-label="Note 5 sur 5">
              {[1, 2, 3, 4, 5].map(star => (
          ...
          {/* Rappel 5 min - Arthur Karting */}
          <motion.div variants={itemVariants} className="bg-primary rounded-3xl p-6 shadow-[0_4px_16px_-6px_rgba(124,58,237,0.3)] hover:shadow-[0_12px_28px_-10px_rgba(124,58,237,0.5)] hover:-translate-y-1 transition-all border border-primary-foreground/10 flex flex-col items-center text-center gap-3 relative overflow-hidden">
            <img src={arthurKarting} alt="Arthur en karting fonçant pour vous rappeler" className="h-20 w-auto object-contain drop-shadow-lg" loading="lazy" decoding="async" />
            <p className="text-sm font-bold text-white">Rappel sous 5 min</p>
            <p className="text-xs text-white/80">Arthur vous rappelle immédiatement pour finaliser</p>
          </motion.div>
        </motion.div>
      </div>
    </section>
