          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
            ...
            <div className="bg-muted/40 border border-border/40 p-4 md:p-5">
              ...
              <div className="flex flex-wrap gap-1.5">
                ...
                <Link to="/blog/jeune-conducteur-voiture-puissante-110-chevaux" className="inline-block text-xs font-medium px-3 py-1.5 rounded-full bg-background border border-border/60 text-muted-foreground hover:text-primary hover:border-primary/40 hover:bg-primary/5 transition-colors">Jeune + voiture puissante</Link>
