      ...
      <div className="container mx-auto px-4">
            ...
            <table className="w-full">
              ...
              <tbody>
                {comparisonData.map((row, index) => (
                  <tr
                    key={row.feature}
                    className={`border-b border-border/30 last:border-b-0 ${index % 2 === 0 ? "bg-background/50" : ""}`}
                  >
                    <td className="p-4">
        ...
        >
          <div className="relative">
            <motion.img
              src={arthurThumbsUp}
              alt="Arthur mascotte jemassuremoinscher - votre guide pour une assurance moins chère"
        ...
        >
          ...
          >
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
              <motion.img
                src={arthurThinking}
                alt="Arthur mascotte jemassuremoinscher réfléchit - trouvez une assurance moins chère"
