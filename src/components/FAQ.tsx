...
const FAQ = () => {
  ...
  const faqData = [
    ...
    { question: "En combien de temps j'ai mes devis ?", answer: "En 2 minutes chrono ! Répondez aux questions, et les meilleures offres s'affichent immédiatement. Un expert vous rappelle ensuite sous 2 heures pour vous aider à choisir." },
