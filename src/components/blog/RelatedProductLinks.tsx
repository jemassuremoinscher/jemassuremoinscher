...
const categoryToProducts: Record<string, ProductLink[]> = {
  "Auto": [
    ...
    { to: "/assurance-trottinette", label: "Assurance trottinette électrique" },
...
const tagToLink: Record<string, ProductLink> = {
  ...
  "trottinette": { to: "/assurance-trottinette", label: "Assurance trottinette électrique" },
  "trottinette électrique": { to: "/assurance-trottinette", label: "Assurance trottinette électrique" },
