...
const tagToLink: Record<string, ProductLink> = {
  ...
  "résiliation": { to: "/blog/resiliation-assurance-droits-2024", label: "Vos droits de résiliation" },
  "loi lemoine": { to: "/blog/loi-lemoine-2025", label: "Tout sur la loi Lemoine" },
