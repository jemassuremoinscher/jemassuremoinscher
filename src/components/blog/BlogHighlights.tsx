          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 text-sm">
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li><button type="button" onClick={() => navigate('/blog/110-chevaux-jeune-conducteur-assurance')} className="bg-transparent border-0 p-0 text-left cursor-pointer hover:underline">• Jeune + voiture puissante</button></li>
