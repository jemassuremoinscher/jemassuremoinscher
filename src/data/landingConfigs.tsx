...
export const landingConfigs: Record<string, AdsLandingProps | { fr: AdsLandingProps; en: AdsLandingProps }> = {
  ...
  trottinette: {
    ...
    seoTitle: "Assurance Trottinette Électrique : Devis dès 3,50€/mois",
    ...
    noindex: true,
    topBarText: "⚡ Trottinette électrique — assurance obligatoire dès 3,50€/mois, attestation immédiate",
    ...
    stats: [
      ...
      { icon: Wallet, value: "3,50€/mois", label: "À partir de" },
      trustReviewStat,
      { icon: Clock, value: "2 min", label: "Pour le devis" },
    ],
    advantages: [
