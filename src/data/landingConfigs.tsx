...
export const landingConfigs: Record<string, AdsLandingProps | { fr: AdsLandingProps; en: AdsLandingProps }> = {
  ...
  auto: {
    fr: {
      ...
      seoDescription: "Compare 50+ assureurs auto avec Arthur en 2 minutes. Service gratuit, sans engagement, courtier indépendant ORIAS. Rappel d'un expert sous 10 minutes.",
      ...
      heroSubtitle: <>Arthur compare <strong className="text-primary">50+ assureurs partenaires</strong> et te trouve le meilleur tarif, sans compromis sur les garanties.</>,
      mascotSrc: arthurCar,
      mascotAlt: "Arthur au volant — comparateur assurance auto jemassuremoinscher.fr",
      speechText: "Salut ! Je compare 50+ assureurs auto pour toi en 2 minutes.",
      insuranceType: "auto",
      ...
      advantages: [
        ...
        { icon: Award, title: "50+ assureurs comparés", description: "AXA, Allianz, MAIF, Matmut, Generali, Direct Assurance, MACIF et bien d'autres." },
      ...
      faqs: [
        { question: "Comment Arthur compare-t-il les assurances auto ?", answer: "Tu remplis le formulaire en 2 minutes avec ton véhicule et ton profil. Arthur interroge en temps réel les 50+ assureurs partenaires et te présente les meilleures offres adaptées à ton profil." },
        { question: "Combien puis-je économiser ?", answer: "Cela dépend de ton profil et de ton contrat actuel. En moyenne, nos utilisateurs économisent jusqu'à 40 % en mettant en concurrence les 50+ assureurs partenaires." },
    ...
    en: {
      ...
      seoDescription: "Compare 50+ car insurers with Arthur in 2 minutes. Free, no commitment, independent ORIAS-registered broker. Expert callback within 10 minutes.",
      ...
      heroSubtitle: <>Arthur compares <strong className="text-primary">50+ partner insurers</strong> and finds the best rate, without compromising on cover.</>,
      mascotSrc: arthurCar,
      mascotAlt: "Arthur driving — car insurance comparator jemassuremoinscher.fr",
      speechText: "Hi! I'll compare 50+ car insurers for you in 2 minutes.",
      insuranceType: "auto",
      ...
      advantages: [
        ...
        { icon: Award, title: "50+ insurers compared", description: "AXA, Allianz, MAIF, Matmut, Generali, Direct Assurance, MACIF and many more." },
      ...
      faqs: [
        { question: "How does Arthur compare car insurance?", answer: "You fill in the 2-minute form with your vehicle and profile. Arthur queries the 50+ partner insurers in real time and shows you the best offers for your profile." },
        { question: "How much can I save?", answer: "It depends on your profile and current contract. On average, our users save up to 40% by putting the 50+ partner insurers in competition." },
