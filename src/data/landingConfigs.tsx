...
export const landingConfigs: Record<string, AdsLandingProps> = {
  ...
  pret: {
    slug: "pret",
    trackingTitle: "Landing Page Assurance Prêt",
    seoTitle: "Assurance Prêt Immobilier -60 % | Loi Lemoine 2026",
    seoDescription: "Économisez jusqu'à 15 000 € sur l'assurance de votre prêt grâce à la loi Lemoine. Devis gratuit.",
    seoKeyword: "assurance prêt immobilier moins chère",
    seoKeywords: "loi Lemoine, délégation assurance emprunteur, ADE",
    topBarText: "💰 Loi Lemoine : changez d'assurance prêt à tout moment, économisez jusqu'à 15 000 €",
    ...
    mascotAlt: "Arthur calcule — assurance prêt immobilier",
    speechText: "Une assurance prêt 4× moins chère, c'est possible. Je vous montre !",
    insuranceType: "pret",
  ...
  "moniteur-sport": {
    ...
    bottomCtaDescription: "RC pro adaptée à votre discipline — devis express en 30 minutes.",
  },
};
