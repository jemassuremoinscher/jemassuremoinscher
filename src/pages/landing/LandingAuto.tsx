    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
        ...
        <div className="bg-accent text-accent-foreground py-2 px-4 text-center font-semibold text-sm md:text-base animate-fade-in">
          ...
          🔥 Offre spéciale Auto : -40% la 1ère année ! Plus que 12 places aujourd'hui
        </div>
            ...
            <div className="space-y-6 animate-fade-in">
              <div>
                <Badge className="mb-4 text-sm px-3 py-1">
                  ...
                  N°1 Assurance Auto en France
                </Badge>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-tight mb-4">
                  Assurance Auto
                  <span className="text-primary block mt-2">jusqu'à -600€/an</span>
                  <span className="block text-2xl md:text-3xl mt-2 text-muted-foreground font-normal">
                    Comparez 30+ assureurs
                  </span>
                </h1>
                <p className="text-lg md:text-xl text-muted-foreground mb-6">
                  Économisez en moyenne <strong className="text-primary">600€ par an</strong> sur votre assurance auto en comparant gratuitement les meilleurs tarifs.
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-4 bg-card rounded-lg border hover-scale">
                  ...
                  <div className="text-xs text-muted-foreground">Automobilistes</div>
                </div>
                <div className="text-center p-4 bg-card rounded-lg border hover-scale">
              ...
              <Card className="p-6 bg-gradient-to-br from-primary/5 to-accent/5 border-2 border-primary/20">
                <h3 className="font-bold text-lg mb-4 flex items-center gap-2">
                  ...
                  Pourquoi nous choisir pour votre assurance auto ?
                </h3>
                <ul className="space-y-3">
                  {[
                    '✅ 100% gratuit et sans engagement',
                    '🏆 Comparaison de 30+ assureurs (AXA, Allianz, Matmut...)',
                    '⚡ Expert dédié qui vous rappelle sous 2h',
                    '💰 Économies garanties ou remboursé',
                    '📞 Service client 5⭐ disponible 7j/7',
                    '🚗 Toutes formules : tiers, intermédiaire, tous risques',
                  ].map((benefit, i) => (
              ...
              <div className="space-y-4">
                <h3 className="font-bold text-lg">🌟 Avis clients assurance auto :</h3>
                {[
                  {
                    name: 'Marc T.',
                    location: 'Lyon',
                    text: 'J\'ai économisé 520€ sur mon assurance auto ! Le conseiller m\'a trouvé une formule tous risques moins chère que mon ancien tiers.',
                    rating: 5,
                  },
                  {
                    name: 'Claire B.',
                    location: 'Paris',
                    text: 'Service ultra rapide. En 30min j\'avais mon nouveau contrat, moins cher avec de meilleures garanties.',
                    rating: 5,
                  },
                  {
                    name: 'Ahmed R.',
                    location: 'Marseille',
                    text: 'Jeune conducteur, j\'ai enfin trouvé une assurance abordable grâce à eux. Merci !',
                    rating: 5,
                  },
                ].map((testimonial, i) => (
