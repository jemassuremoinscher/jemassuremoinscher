...
const AssuranceFlotteAuto = () => (
  <VerticalInsurancePage
    ...
    seoDescription="Comparez les assurances flotte auto entreprise (dès 3 véhicules). Gestion centralisée, un seul contrat pour toute la flotte."
    ...
    faqs={[
      ...
      { question: "Quels avantages versus contrats individuels ?", answer: "Une seule échéance, une gestion centralisée, et l'ajout ou le retrait de véhicules en cours d'année simplifié. L'écart de prix avec des contrats individuels dépend de la taille de la flotte et de sa sinistralité : il n'est pas garanti." },
    ...
    enBrefFacts={[
      ...
      "Un seul contrat pour toute la flotte, au lieu de contrats individuels.",
