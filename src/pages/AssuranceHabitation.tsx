...
const AssuranceHabitation = () => {
  ...
  return (
    <div className="min-h-screen">
      <SEOOptimized title="Assurance Habitation Moins Chère [Month] dès 3€" description="Comparez 50+ assureurs habitation en 2 min. Maison ou appartement, locataire ou propriétaire. Économisez jusqu'à 40%." keyword="assurance habitation moins chère" keywords="assurance maison, assurance appartement, assurance logement, assurance locataire" canonical="https://www.jemassuremoinscher.fr/assurance-habitation" ogTitle="Assurance Habitation Moins Chère [Month] : Comparez 50+ assureurs dès 3€/mois" ogDescription="Comparez 50+ assureurs habitation en 2 minutes. Maison, appartement, locataire ou propriétaire. Devis gratuit, économisez jusqu'à 40% sur votre assurance." twitterDescription="Assurance habitation dès 3€/mois. Comparez 50+ offres en 2 min, économisez jusqu'à 40%. Gratuit et sans engagement." jsonLd={[serviceSchema, faqSchema, insuranceProductSchema]} />
      <Header />
