...
const AssuranceAnimaux = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-br from-primary/5 to-primary/10 py-16 relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center relative">
            <ArthurHero imageSrc={arthurAnimals} imageAlt="Arthur avec des animaux - assurance animaux moins chère" speechText={t('animauxPage.subtitle')} />
      ...
      <div className="container mx-auto px-4 py-12" data-ai-description="Comparateur d'assurance animaux — jemassuremoinscher.fr compare les mutuelles chien et chat">
        <DynamicUpdateDate />
        <EnBref facts={["jemassuremoinscher.fr compare les assurances chien, chat et NAC.", "Assurance animaux dès 8€/mois selon l'espèce et les garanties.", "Remboursement des frais vétérinaires jusqu'à 100%.", "Devis gratuit en moins de 2 minutes, sans engagement."]} />
        ...
        <section className="max-w-2xl mx-auto text-center mb-16">
          <Card className="p-8 bg-primary/5 border-primary/20 relative overflow-visible">
            <img src={arthurFlying} alt="Arthur en vol - économisez sur votre assurance animaux" className="absolute -right-6 -top-10 w-20 h-auto hidden sm:block" width={80} height={100} loading="lazy" decoding="async" />
