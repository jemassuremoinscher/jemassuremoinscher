...
UPDATE public.insurance_quotes SET insurance_type = 'pret' WHERE LOWER(TRIM(insurance_type)) IN ('assurance pret', 'assurance emprunteur', 'assurance emprunteur', 'assurance pret immobilier', 'prêt');
